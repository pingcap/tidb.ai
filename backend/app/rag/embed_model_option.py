...
admin_embed_model_options: List[EmbeddingModelOption] = [
    EmbeddingModelOption(
        ...
        embedding_model_description=f"Please select a text embedding model with {settings.EMBEDDOMG_DIMS} dimensions.",
    ...
    EmbeddingModelOption(
        ...
        embedding_model_description=f"Find more information about Jina AI Embeddings at https://jina.ai/embeddings/, we need a model with {settings.EMBEDDOMG_DIMS} dimensions.",
    ...
    EmbeddingModelOption(
        ...
        embedding_model_description=f"Documentation: https://docs.cohere.com/docs/cohere-embed, we need a model with {settings.EMBEDDOMG_DIMS} dimensions.",
    ...
    EmbeddingModelOption(
        ...
        embedding_model_description=f"https://ollama.com/blog/embedding-models, we need a model with {settings.EMBEDDOMG_DIMS} dimensions.",
