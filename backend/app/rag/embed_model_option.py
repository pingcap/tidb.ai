...
admin_embed_model_options: List[EmbeddingModelOption] = [
    ...
    EmbeddingModelOption(
        ...
        provider_url="https://api.302.ai/v1/embeddings",
        default_embedding_model="BAAI/bge-m3",
        embedding_model_description=f"Please select a text embedding model with {settings.EMBEDDING_DIMS} dimensions.",
    ...
    EmbeddingModelOption(
        provider=EmbeddingProvider.AI302,
        provider_display_name="302AI",
        provider_description="302AI provides a set of platforms that provide text embeddings similar to OpenAI.",
        provider_url="https://api.302.ai/v1/embeddings",
