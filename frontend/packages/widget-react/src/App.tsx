      ...
      <Dialog>
        <DialogTrigger asChild>
          <Button className="fixed right-8 bottom-8 flex gap-2 items-center">
            <img src={dark ? '/answer-black.svg' : '/answer-white.svg'} alt="Logo" className="size-4" />
            <span>
              TiDB.ai
            </span>
          </Button>
          ...
          <DialogPrimitive.Content
            ...
            <DialogHeader>
              <DialogTitle className="flex items-center gap-4">
                <img className="h-8" src={dark ? '/tidb-ai-light.svg' : '/tidb-ai.svg'} alt="logo" height={32} />
