...
The Embedding Model is a machine learning model that is trained to generate embeddings for a given input. The embeddings are then used to generate recommendations for the user. The Embedding Model is trained using the [Embedding Model Trainer](/docs/embedding-model-trainer).
