...
import { BotMessageSquareIcon, CogIcon, CommandIcon, FilesIcon, GaugeIcon, HomeIcon, LibraryIcon, MenuIcon, MessageCircleQuestionIcon, MessagesSquareIcon, PlusIcon, WaypointsIcon } from 'lucide-react';
