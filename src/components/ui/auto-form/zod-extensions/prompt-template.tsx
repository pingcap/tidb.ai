...
export function PromptTemplateEditor ({ name, disabled, ref, value, onChange, onBlur }: { name?: string, disabled?: boolean, ref?: Ref<any>, value?: string, onChange?: (value: string) => void, onBlur?: (event: any) => void }) {
  const { theme } = useTheme();
