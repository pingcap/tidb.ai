 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(I,H){var w=I.length;I.push(H);e:for(;0<w;){var G=w-1>>>1,K=I[G];if(0<o(K,H))I[G]=H,I[w]=K,w=G;else break e}}function n(I){return I.length===0?null:I[0]}function r(I){if(I.length===0)return null;var H=I[0],w=I.pop();if(w!==H){I[0]=w;e:for(var G=0,K=I.length,v=K>>>1;G<v;){var ne=2*(G+1)-1,ye=I[ne],ee=ne+1,Ue=I[ee];if(0>o(ye,w))ee<K&&0>o(Ue,ye)?(I[G]=Ue,I[ee]=w,G=ee):(I[G]=ye,I[ne]=w,G=ne);else if(ee<K&&0>o(Ue,w))I[G]=Ue,I[ee]=w,G=ee;else break e}}return H}function o(I,H){var w=I.sortIndex-H.sortIndex;return w!==0?w:I.id-H.id}if(typeof performance=="object"&&typeof performance.now=="function"){var i=performance;e.unstable_now=function(){return i.now()}}else{var l=Date,a=l.now();e.unstable_now=function(){return l.now()-a}}var s=[],u=[],d=1,c=null,f=3,p=!1,h=!1,y=!1,x=typeof setTimeout=="function"?setTimeout:null,g=typeof clearTimeout=="function"?clearTimeout:null,m=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function k(I){for(var H=n(u);H!==null;){if(H.callback===null)r(u);else if(H.startTime<=I)r(u),H.sortIndex=H.expirationTime,t(s,H);else break;H=n(u)}}function C(I){if(y=!1,k(I),!h)if(n(s)!==null)h=!0,A(T);else{var H=n(u);H!==null&&$(C,H.startTime-I)}}function T(I,H){h=!1,y&&(y=!1,g(_),_=-1),p=!0;var w=f;try{for(k(H),c=n(s);c!==null&&(!(c.expirationTime>H)||I&&!O());){var G=c.callback;if(typeof G=="function"){c.callback=null,f=c.priorityLevel;var K=G(c.expirationTime<=H);H=e.unstable_now(),typeof K=="function"?c.callback=K:c===n(s)&&r(s),k(H)}else r(s);c=n(s)}if(c!==null)var v=!0;else{var ne=n(u);ne!==null&&$(C,ne.startTime-H),v=!1}return v}finally{c=null,f=w,p=!1}}var S=!1,E=null,_=-1,M=5,b=-1;function O(){return!(e.unstable_now()-b<M)}function L(){if(E!==null){var I=e.unstable_now();b=I;var H=!0;try{H=E(!0,I)}finally{H?B():(S=!1,E=null)}}else S=!1}var B;if(typeof m=="function")B=function(){m(L)};else if(typeof MessageChannel<"u"){var W=new MessageChannel,F=W.port2;W.port1.onmessage=L,B=function(){F.postMessage(null)}}else B=function(){x(L,0)};function A(I){E=I,S||(S=!0,B())}function $(I,H){_=x(function(){I(e.unstable_now())},H)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(I){I.callback=null},e.unstable_continueExecution=function(){h||p||(h=!0,A(T))},e.unstable_forceFrameRate=function(I){0>I||125<I?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):M=0<I?Math.floor(1e3/I):5},e.unstable_getCurrentPriorityLevel=function(){return f},e.unstable_getFirstCallbackNode=function(){return n(s)},e.unstable_next=function(I){switch(f){case 1:case 2:case 3:var H=3;break;default:H=f}var w=f;f=H;try{return I()}finally{f=w}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(I,H){switch(I){case 1:case 2:case 3:case 4:case 5:break;default:I=3}var w=f;f=I;try{return H()}finally{f=w}},e.unstable_scheduleCallback=function(I,H,w){var G=e.unstable_now();switch(typeof w=="object"&&w!==null?(w=w.delay,w=typeof w=="number"&&0<w?G+w:G):w=G,I){case 1:var K=-1;break;case 2:K=250;break;case 5:K=1073741823;break;case 4:K=1e4;break;default:K=5e3}return K=w+K,I={id:d++,callback:H,priorityLevel:I,startTime:w,expirationTime:K,sortIndex:-1},w>G?(I.sortIndex=w,t(u,I),n(s)===null&&I===n(u)&&(y?(g(_),_=-1):y=!0,$(C,w-G))):(I.sortIndex=K,t(s,I),h||p||(h=!0,A(T))),I},e.unstable_shouldYield=O,e.unstable_wrapCallback=function(I){var H=f;return function(){var w=f;f=H;try{return I.apply(this,arguments)}finally{f=w}}}})(Im);Rm.exports=Im;var l1=Rm.exports;/**
 * @license React
...
`,b_={background:"hsl(0 0% 100%)",foreground:"hsl(240 10% 3.9%)",card:"hsl(0 0% 100%)",cardForeground:"hsl(240 10% 3.9%)",popover:"hsl(0 0% 100%)",popoverForeground:"hsl(240 10% 3.9%)",primary:"hsl(240 5.9% 10%)",primaryForeground:"hsl(0 0% 98%)",secondary:"hsl(240 4.8% 95.9%)",secondaryForeground:"hsl(240 5.9% 10%)",muted:"hsl(240 4.8% 95.9%)",mutedForeground:"hsl(240 3.8% 46.1%)",accent:"hsl(240 4.8% 95.9%)",accentForeground:"hsl(240 5.9% 10%)",destructive:"hsl(0 84.2% 60.2%)",destructiveForeground:"hsl(0 0% 98%)",border:"hsl(240 5.9% 90%)",input:"hsl(240 5.9% 90%)",ring:"hsl(240 5.9% 10%)"},v_={background:"hsl(240 10% 3.9%)",foreground:"hsl(0 0% 98%)",card:"hsl(240 10% 3.9%)",cardForeground:"hsl(0 0% 98%)",popover:"hsl(240 10% 3.9%)",popoverForeground:"hsl(0 0% 98%)",primary:"hsl(0 0% 98%)",primaryForeground:"hsl(240 5.9% 10%)",secondary:"hsl(240 3.7% 15.9%)",secondaryForeground:"hsl(0 0% 98%)",muted:"hsl(240 3.7% 15.9%)",mutedForeground:"hsl(240 5% 64.9%)",accent:"hsl(240 3.7% 15.9%)",accentForeground:"hsl(0 0% 98%)",destructive:"hsl(0 62.8% 30.6%)",destructiveForeground:"hsl(0 0% 98%)",border:"hsl(240 3.7% 15.9%)",input:"hsl(240 3.7% 15.9%)",ring:"hsl(240 4.9% 83.9%)"},x_=md({palette:{mode:"light",...b_}}),S_=md({palette:{mode:"dark",...v_}}),Kt="tidb-ai-",F0=R.createContext({baseUrl:"",entryButtonLabel:"Ask"});function C_(e){var h;const{exampleQuestions:t}=e,{session:n,setSession:r}=g_(),o=R.useContext(F0);y_();const{messages:i,input:l,handleInputChange:a,handleSubmit:s,isLoading:u,stop:d,reload:c,append:f}=zS({api:o.baseUrl+"/api/v1/chats",body:{...n&&{sessionID:n}},onResponse:y=>{n!==y.headers.get("X-CreateRag-Session")&&r(y.headers.get("X-CreateRag-Session")??void 0)}}),p=y=>{f({role:"user",content:y,createdAt:new Date})};return N.jsx(N.Fragment,{children:N.jsxs(E_,{className:Kt+"Conversation-Container",children:[N.jsxs(T_,{sx:{flexDirection:"column-reverse"},className:"Conversation-Message-List",children:[i.length===0&&t.length>0&&N.jsx(RT,{appendText:p,items:t}),u&&((h=i[i.length-1])==null?void 0:h.role)!=="assistant"&&N.jsx(PT,{}),i.sort((y,x)=>{const g=new Date(y.createdAt||0).getTime();return new Date(x.createdAt||0).getTime()-g}).map((y,x)=>{const g=x===0?!u:y.role!=="user";return N.jsx(_T,{role:y.role==="user"?"user":"bot",className:Kt+"Conversation-Message",Action:g?N.jsx(GT,{handleReload:x===0?c:void 0,content:y.content,className:Kt+"Conversation-Message-Action"}):null,wrapperSx:{...x===0&&{border:"none",marginBottom:0}},children:y.content},y.id)})]}),N.jsxs("div",{children:[(i==null?void 0:i.length)>0&&u&&N.jsx(qT,{className:Kt+"Conversation-Action",handleStop:d}),N.jsx("form",{onSubmit:s,children:N.jsx(YT,{className:Kt+"Conversation-Input",value:l,onChange:a,isLoading:u})}),N.jsxs(e_,{sx:{display:"block",paddingTop:"1rem",fontSize:"12px",color:y=>y.palette.mutedForeground,"& > a":{color:"inherit"}},children:["Powered by ",N.jsx("a",{href:"https://tidb.ai",target:"_blank",rel:"noreferrer",children:"TiDB.ai"})]})]})]})})}const E_=Ie("div")(({theme:e})=>be({display:"flex",flex:"1 1 0%",justifyContent:"space-between",flexDirection:"column",height:"calc(100% - 40px)",backgroundColor:e.palette.background})),T_=Ie("div")(({theme:e})=>be({display:"flex",flexDirection:"column",padding:"0.75rem 0",overflowY:"auto",scrollbarWidth:"thin",scrollbarColor:`${e.palette.accent} ${e.palette.background}`,"&::-webkit-scrollbar":{width:"0.5rem"},"&::-webkit-scrollbar-track":{backgroundColor:e.palette.background},"&::-webkit-scrollbar-thumb":{backgroundColor:e.palette.background,borderRadius:e.shape.borderRadius}},e.palette.mode==="dark"?w_:k_));function __(e){const{btnLabel:t,btnImgSrc:n,baseUrl:r="",exampleQuestions:o,logoSrc:i}=e,[l,a]=R.useState(!1),s=()=>a(!0),u=()=>a(!1),d=xb("(prefers-color-scheme: dark)")?"dark":"light",c=R.useMemo(()=>d==="dark"?S_:x_,[d]);return N.jsx(F0.Provider,{value:{baseUrl:r,entryButtonLabel:t},children:N.jsxs(jv,{theme:c,children:[N.jsxs(ux,{type:"button",onClick:s,className:Kt+"entry-btn",children:[n&&N.jsx("img",{src:n,alt:t,className:Kt+"entry-btn-img",width:16,height:16}),t]}),N.jsx(Ax,{"aria-labelledby":"unstyled-modal-title","aria-describedby":"unstyled-modal-description",open:l,onClose:u,slots:{backdrop:Lx},className:Kt+"Modal",children:N.jsxs(zx,{sx:{width:"90vw",maxWidth:800,minHeight:400,height:"60vh"},className:Kt+"Modal-Content",children:[N.jsx(Mx,{className:Kt+"Modal-Header",children:N.jsxs(Dx,{className:Kt+"Modal-Title",children:[i&&N.jsx("img",{src:i,alt:"Widget Logo",width:32,height:32}),"Conversational Search Box"]})}),N.jsx(C_,{exampleQuestions:o})]})})]})})}const Pe=document.querySelector('script[data-id][data-name="tidb-ai-widget"]'),P_=(Pe==null?void 0:Pe.getAttribute("data-id"))||"tidb-ai-widget",R_=(Pe==null?void 0:Pe.getAttribute("data-name"))||"tidb-ai-widget",I_=(Pe==null?void 0:Pe.getAttribute("data-btn-label"))||"Ask AI",O_=(Pe==null?void 0:Pe.getAttribute("data-btn-img-src"))||void 0,A_=(Pe==null?void 0:Pe.getAttribute("data-api-base-url"))||void 0,L_=JSON.parse((Pe==null?void 0:Pe.getAttribute("data-example-questions"))||"[]"),z_=(Pe==null?void 0:Pe.getAttribute("data-logo-src"))||void 0,M_=document.getElementsByTagName("body")[0];M_.appendChild(document.createElement("div")).id="tidb-ai-root";Qs.createRoot(document.getElementById("tidb-ai-root")).render(N.jsx(yi.StrictMode,{children:N.jsx(__,{id:P_,name:R_,btnLabel:I_,btnImgSrc:O_,baseUrl:A_,exampleQuestions:L_,logoSrc:z_})}));
