...
* An [TiDB Serverless Vector](https://pingcap.com/ai) account, currently only TiDB Serverless tier has the support for the Vector Search. You can use the free tier with 25GiB storage. We suggest to choose a nearby region for better performance according to your location.
