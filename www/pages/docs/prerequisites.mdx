...
## Reranker Service
The reranker service is used to rerank the results retrieved from vector storage. this will help to filter the most relevant corpus to the user query. We are using the following models for this purpose:
